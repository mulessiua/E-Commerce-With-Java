...
.style8 {color: #666666}
.style10 {color: #666666; font-size: larger; }
.style20 {color: #FF0000; font-size: medium; }
.style11 {color: #666666; font-size:  large;}
...
<div id="client">
        <table border="0" align="center" bgcolor="#FFFFFF" >
            <tr>
                <%
            if(htm.getAttribute("tipo")!=null){
                out.println("<td width=153 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Imagem:</span></p></td>");
                out.println("<td width=134 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Nome:</span></p></td>");
                out.println("<td width=194 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Descri&ccedil;&atildeo:</span></p></td>");
                out.println("<td align=center width=147 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Stock/Vendidos:</span></p></td>");
                out.println("<td width=180 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Pre&ccedil;o:</span></p></td>");
            out.println("</tr>");
            ...
            for(Produto p:produtos){
                ...
                carrinhoStock = "<a href=apProdutos?codigo="+p.getProdutoId()+"><img src=img/categoria/computador/trash.png></a>";
                }else{
		...
		out.println("<td><p><img src=img/categoria/computador/"+p.getImagen()+" width=157 height=80></td>");
                ...
                out.println("<td bgcolor=#FFFFFF>"+carrinhoStock+"</td>");
                out.println("</tr>");
            }}
            %>
