...
<div id="client">
		...
		<td width="89" bgcolor=#FFFFFF >&nbsp;</td>
                <td width="99" bgcolor=#FFFFFF>Nome</td>
                <td width="238" bgcolor=#FFFFFF>Descri&ccedil;&atilde;o</td>
                <td bgcolor=#FFFFFF>Stock:</td>
                <td bgcolor=#FFFFFF>Vendidos:</td>
                <td width="207" bgcolor=#FFFFFF>Pre&ccedil;o</td>
				<td width="178" bgcolor=#FFFFFF>&nbsp;</td>
            </tr>
            <%
            for(Produto p:produtos){
                out.println("<form name=editarProduto method=post action=atualizarProduto>");
                out.println("<input type=hidden name=codigo value="+p.getProdutoId()+">");
                out.println("<input type=hidden name=imagen value="+p.getImagen()+">");
                out.println("<input type=hidden name=categoria value="+p.getCategoria()+">");
                out.println("</tr>");
		out.println("<td><img src=img/categoria/computador/"+p.getImagen()+" width=157 height=80></td>");
                out.println("<td bgcolor=#FFFFFF><input type=text name=nome size=20 value='"+p.getNome()+"'></td>");
                out.println("<td bgcolor=#FFFFFF><input type=text name=descricao size=40 value='"+p.getDescricao()+"'></td>");
                out.println("<td bgcolor=#FFFFFF><input type=text name=disponivel size=5 value='"+p.getDisponivel()+"'></td>");
                out.println("<td bgcolor=#FFFFFF><input type=text name=vendido size=5 value='"+p.getVendido()+"'></td>");
                out.println("<td bgcolor=#FFFFFF><input type=text name=preco size=8 value='"+p.getPreco()+"'> MZN</td>");
                out.println("<td bgcolor=#FFFFFF>"+"<input type=submit value=Atualizar>");
                out.println("</tr>");
                out.println("</form>");
            }
            %>
