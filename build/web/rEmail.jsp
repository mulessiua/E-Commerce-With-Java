 ...
 %>
        ...
        <% if (request.getParameter("email") != null)  {
            email = request.getParameter("email");
                ...
                %>
				<p align="center" class="green style11 style7">Recuperar o Password</p>
				<p align="center" class="green style11 style7">&nbsp;</p>
				<p align="center" class="green style11 style7">Insira o seu E-mail aqui </p>
				<p align="center" class="green style11 style7">&nbsp;</p>


				<table width="200" border="1" align="center" id="media" name="service">
				<form name="form1" method="post" action="rEmail">
                  <tr>
                    <td width="44">E-mail:</td>
                    <td width="140"><input type="text" name="email"/></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="submit" name="Submit" value="Procurar" onClick="return validateForm()">                    </td>
                  </tr>
				  </form>
          </table>
