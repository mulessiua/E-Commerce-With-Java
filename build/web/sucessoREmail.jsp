...
.style12 {color: #FF0000; font-size: x-large;}
...
out.println("<br>");}
 ...
 %>
			...
			<p align="center" class="green style11 style7">Obrigado! Enviaremos o seu password para o e-mail <br>
			</p><br>
			<p align="center" class="style12"><%=email%>		</p>
                        <br>
			<p align="center" class="style8"> <a href="index.jsp" class="style8 style11">P&aacute;gina Inicial</a></p>
	  </header>
	</div>
