 ...
 */
@WebServlet(name="criarProdutos", urlPatterns={"/criarProdutos"})
public class criarProdutos extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect(request.getContextPath() +"/sucessoCriar.jsp");
