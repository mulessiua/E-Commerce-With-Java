 ...
 */
@WebServlet(name="listarCadastros", urlPatterns={"/listarCadastros"})
public class listarCadastros extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            cadastros = fc.selectAll();


            String nextJsp = "/aCadastros.jsp";
