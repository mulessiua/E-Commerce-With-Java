...
<div id="client">
        <table border="0" align="center" bgcolor="#FFFFFF" >
            <tr>
                <%
                if(htm.getAttribute("tipo")!=null){
				out.println("<td width=188 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Nome:</span></p></td>");
                out.println("<td width=156 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Apelido:</span></p></td>");
                out.println("<td width=380 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>E-mail:</span></p></td>");
                out.println("<td width=214 height=50 bgcolor=#FFFFFF ><p align=center><span class=style11>Telefone:</span></p></td>");
                out.println("</tr>");
            
            for(Cadastro c:cadastros){
                out.println("<tr>");
				out.println("<td height=50 bgcolor=#FFFFFF><p align=center>"+c.getNome()+"</p></td>");
                out.println("<td height=50 bgcolor=#FFFFFF><p align=center>"+c.getApelido()+"</p></td>");
                out.println("<td height=50 bgcolor=#FFFFFF><p align=center>"+c.getEmail()+"</p></td>");
                out.println("<td height=50 bgcolor=#FFFFFF><p align=center>"+c.getTelefone()+"</p></td>");
                out.println("</tr>");
            }}
            %>
  </table>
