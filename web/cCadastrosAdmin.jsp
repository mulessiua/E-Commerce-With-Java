...
out.println("<br>");}
 %>
                        ...
                        <h1 a align="center"class="green style7">Login efetuado com sucesso</h1>
                        <p class="green style7">&nbsp;</p>
                        <p align="center" class="green style7"><a href="admin.jsp" title="admin" class="style8">Efectuar altera&ccedil;&otilde;es</a></p>
                        <br>
        </header>
	</div>
